...
5. To upgrade your version of Magic Zoom Plus (which removes the "Please upgrade" text), buy Magic Zoom Plus and overwrite the skin/frontend/[your_interface]/[your_theme]/js/magiczoomplus.js file file with the new one in your licensed version.
